(function ($) {
    ...
    function initializeMultiPeoplePicker(eleId) {
        // Create a schema to store picker properties, and set the properties.
        var schema = {};
        schema['PrincipalAccountType'] = 'User,DL,SecGroup,SPGroup';
        schema['SearchPrincipalSource'] = 15;
    ...
    function GetPeoplePickerValues(eleId) {
        ...
        if (peoplePicker != null) {
            ...
            debugger;
                ...
                //Added by abhinow to get only one user
                break;
            }
            return userInfo;
        }
    ...
    function GetPeoplePickerLoginname(eleId) {
        var toSpanKey = eleId + "_TopSpan";
        var peoplePicker = null;
    ...
    $.fn.spMultiPeoplePicker = function () {
        var eleId = $(this).attr('id');
        ExecuteOrDelayUntilScriptLoaded(function () { initializeMultiPeoplePicker(eleId); }, 'sp.core.js');
    };
    ...
    $.fn.getUserLogin = function () {
        var eleId = $(this).attr('id');
        var spUsersInfo = GetPeoplePickerLoginname(eleId);
        return spUsersInfo;
    }
