...
'<div class="toggle btn btn-primary" data-toggle="toggle" style="width: 0px; height: 0px;">'+
	  ...
	  // ' <input type="checkbox" class="checkbox-image" checked data-toggle="toggle" data-on="<img src="img/checked.png">" data-off="<img src="img/close.png">">'+
	  '<div class="toggle-group"><label class="btn btn-primary toggle-on"><img src="https://aufaitcloud.sharepoint.com/sites/Mrs_Bectors_PTMS/BectorsSourceCode/Images/checked.png"></label><label class="btn btn-default active toggle-off"><img src="https://aufaitcloud.sharepoint.com/sites/Mrs_Bectors_PTMS/BectorsSourceCode/Images/close.png"></label><span class="toggle-handle btn btn-default"></span></div>'+
'</div>'+
'</div>'+
