...
{
	var SelectQuery = "?$select=Id,Title,DepartmentId/Id,DepartmentId/Title,RoleId/Id,RoleId/Sequence,RoleId/RoleName,IsActive,PlantId/Id,PlantId/Title";
...
function FillEmployeeDetails(result)
{
	 ...
	 if(result.RoleId.RoleName!=null)
	 {
    	objEmployeeDetails.RoleName= result.RoleId.RoleName;
     }
	else
	 {
...
{
	var SelectQuery = "?$select=Id,Title,Category/Id,DepartmentId/Id,Criteria";
	var filterQuery = SelectedFilter
	var ExpandQuery="&$expand=Category,DepartmentId";
