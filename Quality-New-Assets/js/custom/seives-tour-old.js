...
function defectCycleDynamic(cycleNum) {
  const titles = [
    "Sugar Sifter 1", "Sugar Sifter 2", "sugar grinder mesh - Line 1",
    "sugar grinder mesh - Line 2", "sugar grinder mesh - Line 3", "sugar grinder mesh - Line 4", "Maida Sifter Sieve - Line 1", "Maida Sifter Sieve - Line 2", "Maida Sifter Sieve - Line 3", "Maida Sifter Sieve - Line 4",
    "Sugar Mesh at rotary line-1", "Biscuits Dust 1", "Biscuits Dust 2", "Chemical Sifter 1",
    "Chemical Sifter 3", "Chemical Sifter 5", "Atta shifter", "Maida Seive for sampling", "Invert Syrup - Bucket Filter (Every Batch Change)", "Palm Oil/ Olein (Checked when Oil filled in Silo tank)", "DH room humidity Cookies/Cracker", "Packing humidity & Temp line-1", "Packing humidity & Temp line-2", "Packing humidity & Temp line-3", "Packing humidity & Temp line-4", "Packing humidity & Temp line-5", "Cold room 1 temperature", "Cold room 2 temperature", "Cold room 3 temperature", "Deep freezer for yeast", "Maida hopper magnet line-1", "Maida hopper magnet line-2", "Maida hopper magnet line-3", "Maida hopper magnet line-4", "Sugar grinder Magnet", "Biscuit dust magnet 1", "Biscuit dust magnet 1"
  ];
    ...
    if (card) {
      ...
      if (cr3ea_criteria) {
        let data = {
          ...
          "cr3ea_title": `SeivesOld_${moment().format('MM-DD-YYYY')}`,
